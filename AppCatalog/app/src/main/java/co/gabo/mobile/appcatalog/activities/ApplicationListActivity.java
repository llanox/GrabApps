...
/**
 * An activity representing a single Application detail screen. This
...
public class ApplicationListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putSerializable(Constants.CATEGORY_OBJECT_KEY,
                    getIntent().getSerializableExtra(Constants.CATEGORY_OBJECT_KEY));

            ApplicationListFragment fragment = new ApplicationListFragment();
            fragment.setArguments(arguments);
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.application_list_container, fragment)
                    .commit();
        }
    }
