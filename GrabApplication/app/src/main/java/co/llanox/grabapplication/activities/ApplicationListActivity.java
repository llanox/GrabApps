...
import co.llanox.grabapplication.fragments.CategoryDetailFragment;
import co.llanox.grabapplication.fragments.OnFragmentInteractionListener;
 ...
 */
public class ApplicationListActivity extends AppCompatActivity implements OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            Category cat = (Category) this.getIntent().getSerializableExtra(Constants.CATEGORY_INSTANCE);

            Bundle arguments = new Bundle();
            arguments.putSerializable(Constants.CATEGORY_INSTANCE,
                    getIntent().getSerializableExtra(Constants.CATEGORY_INSTANCE));
            ApplicationListFragment fragment = new ApplicationListFragment();
            fragment.setArguments(arguments);
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.applications_category_container, fragment)
                    .commit();
        }
    }
